...
class UsuariosController extends AbstractController
{
    ...
    #[Route('/{idUsuario}', name: 'app_usuarios_show', methods: ['GET'])]
    ...
    #[Route('/{idUsuario}/edit', name: 'app_usuarios_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idUsuario}', name: 'app_usuarios_delete', methods: ['POST'])]
