...
class ZonaController extends AbstractController
{
    ...
    #[Route('/{idZona}', name: 'app_zona_show', methods: ['GET'])]
    ...
    #[Route('/{idZona}/edit', name: 'app_zona_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idZona}', name: 'app_zona_delete', methods: ['POST'])]
    public function delete(Request $request, Zona $zona, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$zona->getIdZona(), $request->request->get('_token'))) {
