...
class UsuariosControllerTest extends WebTestCase
{
    ...
    private string $path = '/usuarios/';

    protected function setUp(): void
    {
        $this->client = static::createClient();
        $this->manager = static::getContainer()->get('doctrine')->getManager();
        $this->repository = $this->manager->getRepository(Usuarios::class);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'usuario[usuario]' => 'Something New',
            'usuario[password]' => 'Something New',
        ]);

        self::assertResponseRedirects('/usuarios/');
